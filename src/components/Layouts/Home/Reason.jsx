      ...
      <div className="container px-6 mt-24 font-inter lg:flex lg:px-12">
        <div className="lg:w-1/2 text-center lg:text-start lg:my-auto lg:items-center">
          ...
          <p className="text-sm font-serif mb-2">
            At Sajian du Monde, we don{"'"}t just serve food, we bring
            experiences. Each dish is a perfect blend of flavor, presentation
            and tradition. We present dishes that not only delight the palate,
            but also enrich the soul.
          </p>
          <Link to="/menu">
            <Button classname="bg-red-500 mt-3 px-4 py-3 hover:bg-red-600 mb-6">
              Book A Table
            </Button>
          </Link>
        </div>
